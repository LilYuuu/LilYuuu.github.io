...
function setup() {
    ...
    // light
    light = new Point3D(random(windowWidth / 4, windowWidth * 3 / 4), random(windowHeight / 4, windowHeight * 3 / 4), 300)
    ...
    // buildings
    for (let i = 0; i < 7; i++) {
        var c = new Cube(new Point3D(random(windowWidth / 4, windowWidth * 3 / 4), random(windowHeight / 4, windowHeight * 3 / 4), 20))
        buildings.push(c)
    }

    // people
    for (var i = 0; i < 7; i++) {
        var p = new Person(random(windowWidth / 4, windowWidth * 3 / 4), random(windowWidth / 4, windowWidth * 3 / 4), light)
        people.push(p)
    ...
    // trees
    for (var i = 0; i < 7; i++) {
        // trees.push(new Tree(random(windowWidth / 4, windowWidth * 3 / 4), random(windowHeight / 4, windowHeight * 3 / 4)))
        let a = random(360);
